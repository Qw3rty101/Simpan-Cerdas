...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  require_once '../app/core/Database.php'; // Sertakan file Database.php
  ...
  $koneksi = $database->getConnection();
    ...
    // Query SQL untuk mengambil data pengguna berdasarkan email
    $sql = "SELECT * FROM `tbl_anggota` WHERE `email_anggota` = :email LIMIT 1";
    ...
    if ($user && password_verify($password, $user['password_anggota'])) {
        ...
        $_SESSION['anggota'] = $user['id_anggota'];
        $_SESSION['role'] = $user['role_anggota'];
